...
import maenv
from maenv.utils.conversions import aec_to_parallel_wrapper, parallel_to_aec_wrapper
from maenv.utils.wrappers import BaseWrapper
...
def api_test(env, num_cycles=1000, verbose_progress=False):
    ...
    assert isinstance(env, maenv.AECEnv), "Env must be an instance of pettingzoo.AECEnv"
    ...
    base_render = maenv.utils.env.AECEnv.render
    base_close = maenv.utils.env.AECEnv.close
