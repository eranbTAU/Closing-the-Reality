...
from carnet.losses import L1Loss
from carnet.models import init_weights,ConFNet4
...
# Dataset options
parser.add_argument('--dataset_name', default='1_car', type=str)
...
parser.add_argument('--weight_decay', default=0.006273913713486183, type=float)
