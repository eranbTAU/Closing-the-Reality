...
class TextLine:
    def __init__(self, window, idx, color, font_size):
        self.idx = idx
        self.color = color
        self.font_size = font_size
        self.window = window
        pyglet.font.add_file(os.path.join(r'E:\CarProject\NewCode_Project\Simulator', "secrcode.ttf"))
        self.label = None
        self.set_text('')
