...
from Fish.gan.carnet.data.loader import data_loader
from Fish.gan.carnet.models import init_weights, ConFNet, FNet, CNN, LSTM, GRU, ConFNet, ConFNet4
from Fish.gan.carnet.utils import get_dset_path, get_total_norm, save_states
...
# Dataset options
parser.add_argument('--dataset_name', default='datasets_synthetic', type=str)
parser.add_argument('--loader_num_workers', default=0, type=int)

parser.add_argument('--x_mean', default=0.4858, type=int)
parser.add_argument('--x_std', default=0.3927, type=int)
parser.add_argument('--y_mean', default=9.1262, type=int)
parser.add_argument('--y_std', default=20.8873, type=int)
parser.add_argument('--a_mean', default=-1.9554, type=int)
parser.add_argument('--a_std', default=13.7231, type=int)
parser.add_argument('--an_mean', default=-7.7897, type=int)
parser.add_argument('--an_std', default=29.3421, type=int)
parser.add_argument('--am_mean', default=24.0856, type=int)
parser.add_argument('--am_std', default=11.9791, type=int)
parser.add_argument('--d_mean', default=1.8730, type=int)
parser.add_argument('--d_std', default=17.5728, type=int)
parser.add_argument('--dx_mean', default=-1.1641, type=int)
parser.add_argument('--dx_std', default=24.2767, type=int)
parser.add_argument('--dy_mean', default=32.6478, type=int)
parser.add_argument('--dy_std', default=28.9605, type=int)
parser.add_argument('--dtheta_mean', default=0.2759, type=int)
parser.add_argument('--dtheta_std', default=0.5773, type=int)

# parser.add_argument('--x_mean', default=0.4909, type=int)
# parser.add_argument('--x_std', default=0.2364, type=int)
# parser.add_argument('--y_mean', default=0.5127, type=int)
# parser.add_argument('--y_std', default=0.2301, type=int)
# parser.add_argument('--a_mean', default=0.4880, type=int)
# parser.add_argument('--a_std', default=0.2779, type=int)
# parser.add_argument('--an_mean', default=1.9258, type=int)
# parser.add_argument('--an_std', default=36.4344, type=int)
# parser.add_argument('--am_mean', default=27.6549, type=int)
# parser.add_argument('--am_std', default=16.4413, type=int)
# parser.add_argument('--d_mean', default=6.1299, type=int)
# parser.add_argument('--d_std', default=1.4265, type=int)
# parser.add_argument('--dx_mean', default=6.8760e-01, type=int)
# parser.add_argument('--dx_std', default=27.1033, type=int)
# parser.add_argument('--dy_mean', default=3.0670e+01, type=int)
# parser.add_argument('--dy_std', default=33.4764, type=int)
# parser.add_argument('--dtheta_mean', default=9.6918e-04, type=int)
# parser.add_argument('--dtheta_std', default=0.5003, type=int)
...
parser.add_argument('--learning_rate', default=0.862253137577558e-01, type=float)
parser.add_argument('--beta1', default=0.9970569807817551, type=float)
parser.add_argument('--beta2', default=0.2592079885749976, type=float)
parser.add_argument('--weight_decay', default=0.807733941124966811, type=float)
parser.add_argument('--steps', default=1, type=int)
...
def load_samples(file_name):
    samples = pickle.load(file=open(file_name, "rb"))
    sample_x = samples[0]
    sample_y = samples[1]
    return sample_x, sample_y

def eval(fully_model):
    dir_white = r'E:\CarProject\Fish\datasets\test.pkl'
...
def init_weights(m):
    ...
    if classname.find('Linear') != -1:
        ...
        #20.382999420166016 xavier_uniform
...
def main(args):
    ...
    # state = torch.load(r'E:\CarProject\Fish\gan\checkpoint_val\model_Wed_Feb__2_17_58_48.pt')
    # fully_model.load_state_dict(state['best_state_val'])
    ...
    checkdir = r'E:\CarProject\Fish\gan\checkpoint'
    checkpoint_val_dir = r'E:\CarProject\Fish\gan\checkpoint_val'
    checkdirstate = r'E:\CarProject\Fish\gan\checkpoint_state'
